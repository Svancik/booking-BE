...
export const getHotelRooms = async (req,res, next)=>{
  try {
    const hotel = await Hotel.findById(req.params.id);
    //Promise = obj vstupující do await událost
    const list = await Promise.all(hotel.rooms.map(room => {
      //V modelu Hotel.js procházíme elementy pole room - ty obsahuje id místností a na základě těchto id hledáme v databázi ty místnosti s tímto id v modelu Room.js
